...
<title>proEO | Net Present Value Monthly</title>
...
<style>
table.avtable_2 td.label {width: 180px !important;}
    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('net_present_value_monthly'); ?>">
        ...
        <td class="tcontent" rowspan="2">
			...
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > "
				...
				."<span class='orange'>Monthly</span>";
            ...
            <div class="content_div" >
                ...
                <table id="tb1" class="avtable_2" >
					...
					?>
					<tr class="tmain" style="background-color: #C0C0C0 !important;">
						<td class="label" style="background-color: #C0C0C0 !important;">Plan Version (Base Line)</td>
					...
					<tr class="tmain">
						<td class="label" style="background-color: #F0F0F0 !important;">&nbsp;&nbsp;Total Resource Cost</td>
					...
					<tr >
						<td class="label">&nbsp;&nbsp;Product Profitability</td>
					...
					<tr class="tmain">
						<td class="label" style="background-color: #F0F0F0 !important;">&nbsp;&nbsp;Gross Product Margin</td>
					...
					<tr class="tmain" style="background-color: #C0C0C0 !important;">
						<td  class="label" style="background-color: #C0C0C0 !important;">Investment Initiative Version (TO-BE)</td>
...
<?php
	...
	$update_cube = $this->jedoxapi->cell_replace($database_1, $cube_1, $new_area, $gmp);
	$update_cube1 = $this->jedoxapi->cell_replace($database_1, $cube_1, $new_area1, $roi);
	$update_cube2 = $this->jedoxapi->cell_replace($database_1, $cube_1, $new_area2, $pby);
	//print_r ($database_1."---".$cube_1."---".$new_area."----".$gmp);
	//print_r ($database_1."---".$cube_1."---".$new_area1."----".$roi);
	//print_r ($database_1."---".$cube_1."---".$new_area2."----".$pby);
	//print_r($update_cube."--".$update_cube1."--".$update_cube2);
