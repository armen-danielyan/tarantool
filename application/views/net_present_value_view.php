...
<title>proEO | Net Present Value</title>
    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('net_present_value'); ?>">
        ...
        <td class="tcontent" rowspan="2">
            <?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Net Present Value</span>";
            ...
            <div class="content_div" >
            	<div class="clearfix">
                		...
                		<a id="togmonths" href="#" onclick="return false;">Show/Hide Months</a>
					</form><br />&nbsp;
				</div>
                ...
                <table id="tb1" class="avtable_2">
					...
					<tr>
                    	...
                    	<td ><?php echo CUR_SIGN." ".number_format($anpv, 0, ".", ","); ?></td>
						<td ><?php echo CUR_SIGN." ".number_format($atot, 0, ".", ","); ?></td>
                ...
                ?>
                <table id="tb2" class="avtable_2" style="margin-top: 20px !important;">
                	<tr class="tmain">
