	...
	<tr>
		<td id="tsidebar">
			...
			<div id="filter_menu">
			    <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('profitability_product_group_brewing'); ?>">
		...
		<td class="tcontent" rowspan="2">
			<?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Profitability by Product Group</span>";
			...
			<div class="content_div">	
				<table id="tb1" class="avtable_2">
					...
					<?php
						// COGM / Barrel
						$arrow = '';
						$a12 = $b12 = $c12 = $d12 = $e12 = $f12 = $g12 = 0;
						foreach($table12_data as $row)
						{
							$paths = explode(",", $row['path']);
							if($version_a == $paths['0'])
							{
					...
					?>
					<tr class="tmain1">
						<td class="label">COGM / Barrel</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;"><?php echo $arrow; ?></td>
                    	<td ><?php echo CUR_SIGN." ".number_format($a12, 2, ".", ","); ?></td>
						<td ><?php echo CUR_SIGN." ".number_format($b12, 2, ".", ","); ?></td>
						<td ><?php echo CUR_SIGN." ".number_format($c12, 2, ".", ","); ?></td>
						<td ><?php echo CUR_SIGN." ".number_format($d12, 2, ".", ","); ?></td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td >&nbsp;</td>
						<td >&nbsp;</td>
					...
					<?php
						// Water Beer Ratio by Plant
						$arrow = '';
						$a13 = $b13 = $c13 = $d13 = $e13 = $f13 = $g13 = 0;
						foreach($table13_data as $row)
						{
							$paths = explode(",", $row['path']);
							if($version_a == $paths['0'])
							{
					...
					?>
					<tr class="tmain1">
						<td class="label">Water Beer Ratio by Plant</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;"><?php echo $arrow; ?></td>
                    	<td ><?php echo number_format($a13, 2, ".", ","); ?></td>
						<td ><?php echo number_format($b13, 2, ".", ","); ?></td>
						<td ><?php echo number_format($c13, 2, ".", ","); ?></td>
						<td ><?php echo number_format($d13, 2, ".", ","); ?></td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td >&nbsp;</td>
						<td >&nbsp;</td>
