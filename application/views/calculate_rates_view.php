...
<title>proEO | Calculate Rates</title>
...
<table class="content_block" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="tcontent" rowspan="2">
			<?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Calculate Rates</span>";
			$this->load->view("header", array("breadcrumb" => $breadcrumb)); 
			?>
			
			<iframe src="<?php echo base_url(); ?>assets/calculate_rates/index.php" style="margin: 10px 0; width: 802px; height: 600px" frameborder="0" seamless="seamless" scrolling="auto"></iframe>
