    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('efficiency_products_v2'); ?>">
        ...
        <td class="tcontent" rowspan="2">
            <?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Products</span> > ".anchor('efficiency_products_details_v2', 'Details', array('title' => 'View Efficiency Products Details'));
            ...
            <div class="content_div" >
                <table id="tb1" class="avtable_2 controller">
					...
					<tr data-level="<?php echo $true_depth; ?>" id="level_<?php echo $true_depth."_".$sub_depth; ?>" >
						...
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td><?php echo CUR_SIGN." ".number_format($i, 2, ".", ","); ?></td>
						<td><?php echo CUR_SIGN." ".number_format($j, 2, ".", ","); ?></td>
						<td><?php echo CUR_SIGN." ".number_format($k, 2, ".", ","); ?></td>
						<td><?php echo CUR_SIGN." ".number_format($l, 2, ".", ","); ?></td>
					</tr>
					<?php	
							}
...
var myChart3 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSColumn2D.swf", "chartId_3", "600", "350", "0", "1");
