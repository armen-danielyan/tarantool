...
<title>proEO | Manufacturing KPI</title>
    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('manufacturing_kpi'); ?>">
                        ...
                        <div class="filter_div">
                            ...
                            <select name="Measure_Value" onchange="this.form.submit();" class="ddown1" title="Select KPI">
                            <?php
                                foreach($form_Measure_Value as $row)
                                {
                                    $depth = '';
                            ...
                            ?>  
                                <option value="<?php echo $row['element']; ?>" <?php if($Measure_Value == $row['element']){ $n_Measure_Value = $row['name_element']; ?>selected="selected"<?php } ?> ><?php echo $depth.$row['name_element']; ?></option>
                            <?php   
                                }
                            ?>
                            </select>
        ...
        <td class="tcontent" rowspan="2">
            <?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Manufacturing KPI</span>";
                ...
                <div class="tabbertab">
                	...
                	<table>
                    	...
                    	<tr>
                    		...
                    		<td>
		                        <div id="chartContainer6" >chart6 here</div>
                    		</td>
                    	</tr>
                	</table>
                </div>
                <div class="tabbertab">
                    ...
                    <table>
                    	...
                    	<tr>
                    		<td>
                    			<div class="filter_div">
		                            <select name="Measure_Value2" onchange="this.form.submit();" class="ddown1" title="Select KPI">
		                            <?php
		                                foreach($form_Measure_Value as $row)
		                                {
		                                    $depth = '';
		                            ...
		                            ?>  
		                                <option value="<?php echo $row['element']; ?>" <?php if($Measure_Value2 == $row['element']){ $n_Measure_Value2 = $row['name_element']; ?>selected="selected"<?php } ?> ><?php echo $depth.$row['name_element']; ?></option>
		                            <?php   
		                                }
		                            ?>
		                            </select>
                    		...
                    		<td>
                    			<div class="filter_div">
		                            <select name="Measure_Value3" onchange="this.form.submit();" class="ddown1" title="Select KPI">
		                            <?php
		                                foreach($form_Measure_Value as $row)
		                                {
		                                    $depth = '';
		                            ...
		                            ?>  
		                                <option value="<?php echo $row['element']; ?>" <?php if($Measure_Value3 == $row['element']){ $n_Measure_Value3 = $row['name_element']; ?>selected="selected"<?php } ?> ><?php echo $depth.$row['name_element']; ?></option>
		                            <?php   
		                                }
		                            ?>
		                            </select>
                ...
                <table id="operationsdata" class="avtable_2">
                    <tbody>
                		...
                		<?php
							...
							$chart6xml .= "<category label='".$dmonth1."' />";
							...
							$chart6xml .= "<category label='".$dmonth2."' />";
							...
							$chart6xml .= "<category label='".$dmonth3."' />";
							...
							$chart6xml .= "<category label='".$dmonth4."' />";
							...
							$chart6xml .= "<category label='".$dmonth5."' />";
							...
							$chart6xml .= "<category label='".$dmonth6."' />";
							...
							$chart6xml .= "<category label='".$dmonth7."' />";
							...
							$chart6xml .= "<category label='".$dmonth8."' />";
							...
							$chart6xml .= "<category label='".$dmonth9."' />";
							...
							$chart6xml .= "<category label='".$dmonth10."' />";
							...
							$chart6xml .= "<category label='".$dmonth11."' />";
							...
							$chart6xml .= "<category label='".$dmonth12."' />";
							...
							foreach ($form_version as $fdatarow)
							{
								...
								foreach ($chart2_data as $fvals)
								{
									...
									if($fpaths[1] == $y_id1 && $fpaths[0] == $fdatarow['element'])
									{
										$b1 = $fvals['value'];
									}
									if($fpaths[1] == $y_id2 && $fpaths[0] == $fdatarow['element'])
									{
										$b2 = $fvals['value'];
									}
									if($fpaths[1] == $y_id3 && $fpaths[0] == $fdatarow['element'])
									{
										$b3 = $fvals['value'];
									}
									if($fpaths[1] == $y_id4 && $fpaths[0] == $fdatarow['element'])
									{
										$b4 = $fvals['value'];
									}
									if($fpaths[1] == $y_id5 && $fpaths[0] == $fdatarow['element'])
									{
										$b5 = $fvals['value'];
									}
									if($fpaths[1] == $y_id6 && $fpaths[0] == $fdatarow['element'])
									{
										$b6 = $fvals['value'];
									}
									if($fpaths[1] == $y_id7 && $fpaths[0] == $fdatarow['element'])
									{
										$b7 = $fvals['value'];
									}
									if($fpaths[1] == $y_id8 && $fpaths[0] == $fdatarow['element'])
									{
										$b8 = $fvals['value'];
									}
									if($fpaths[1] == $y_id9 && $fpaths[0] == $fdatarow['element'])
									{
										$b9 = $fvals['value'];
									}
									if($fpaths[1] == $y_id10 && $fpaths[0] == $fdatarow['element'])
									{
										$b10 = $fvals['value'];
									}
									if($fpaths[1] == $y_id11 && $fpaths[0] == $fdatarow['element'])
									{
										$b11 = $fvals['value'];
									}
									if($fpaths[1] == $y_id12 && $fpaths[0] == $fdatarow['element'])
									{
										$b12 = $fvals['value'];
									}
							...
							//chart4 genarate
							foreach($Measure_Value_all_alias as $hdatarow)
							{
								$d1 = 0;
								$d2 = 0;
								$d3 = 0;
								...
								foreach($chart4_data as $c4vals)
								{
									...
									if($c4paths[1] == $y_id1 && $c4paths[2] == $hdatarow['element'])
									{
										$d1 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id2 && $c4paths[2] == $hdatarow['element'])
									{
										$d2 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id3 && $c4paths[2] == $hdatarow['element'])
									{
										$d3 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id4 && $c4paths[2] == $hdatarow['element'])
									{
										$d4 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id5 && $c4paths[2] == $hdatarow['element'])
									{
										$d5 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id6 && $c4paths[2] == $hdatarow['element'])
									{
										$d6 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id7 && $c4paths[2] == $hdatarow['element'])
									{
										$d7 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id8 && $c4paths[2] == $hdatarow['element'])
									{
										$d8 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id9 && $c4paths[2] == $hdatarow['element'])
									{
										$d9 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id10 && $c4paths[2] == $hdatarow['element'])
									{
										$d10 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id11 && $c4paths[2] == $hdatarow['element'])
									{
										$d11 = $c4vals['value'];
									}
									if($c4paths[1] == $y_id12 && $c4paths[2] == $hdatarow['element'])
									{
										$d12 = $c4vals['value'];
									}
							...
							foreach ($form_version as $gdatarow)
							{
								...
								foreach ($chart5_data as $gvals)
								{
									...
									if($gpaths[1] == $y_id1 && $gpaths[0] == $gdatarow['element'])
									{
										$c1 = $gvals['value'];
									}
									if($gpaths[1] == $y_id2 && $gpaths[0] == $gdatarow['element'])
									{
										$c2 = $gvals['value'];
									}
									if($gpaths[1] == $y_id3 && $gpaths[0] == $gdatarow['element'])
									{
										$c3 = $gvals['value'];
									}
									if($gpaths[1] == $y_id4 && $gpaths[0] == $gdatarow['element'])
									{
										$c4 = $gvals['value'];
									}
									if($gpaths[1] == $y_id5 && $gpaths[0] == $gdatarow['element'])
									{
										$c5 = $gvals['value'];
									}
									if($gpaths[1] == $y_id6 && $gpaths[0] == $gdatarow['element'])
									{
										$c6 = $gvals['value'];
									}
									if($gpaths[1] == $y_id7 && $gpaths[0] == $gdatarow['element'])
									{
										$c7 = $gvals['value'];
									}
									if($gpaths[1] == $y_id8 && $gpaths[0] == $gdatarow['element'])
									{
										$c8 = $gvals['value'];
									}
									if($gpaths[1] == $y_id9 && $gpaths[0] == $gdatarow['element'])
									{
										$c9 = $gvals['value'];
									}
									if($gpaths[1] == $y_id10 && $gpaths[0] == $gdatarow['element'])
									{
										$c10 = $gvals['value'];
									}
									if($gpaths[1] == $y_id11 && $gpaths[0] == $gdatarow['element'])
									{
										$c11 = $gvals['value'];
									}
									if($gpaths[1] == $y_id12 && $gpaths[0] == $gdatarow['element'])
									{
										$c12 = $gvals['value'];
									}
							...
							//chart6 genarate
							foreach($Measure_Value_all2_alias as $hdatarow)
							{
								$d1 = 0;
								$d2 = 0;
								$d3 = 0;
								...
								$chart6xml .= "<dataset seriesName='".$hdatarow['name_element']."'>";
								
								foreach($chart6_data as $c4vals)
								{
									$c4paths = explode(",", $c4vals['path']);
									if($c4paths[1] == $y_id1 && $c4paths[2] == $hdatarow['element'])
									{
								...
								$chart6xml .= "<set value='".$d1."' />";
								$chart6xml .= "<set value='".$d2."' />";
								$chart6xml .= "<set value='".$d3."' />";
								$chart6xml .= "<set value='".$d4."' />";
								$chart6xml .= "<set value='".$d5."' />";
								$chart6xml .= "<set value='".$d6."' />";
								$chart6xml .= "<set value='".$d7."' />";
								$chart6xml .= "<set value='".$d8."' />";
								$chart6xml .= "<set value='".$d9."' />";
								$chart6xml .= "<set value='".$d10."' />";
								$chart6xml .= "<set value='".$d11."' />";
								$chart6xml .= "<set value='".$d12."' />";
								$chart6xml .= "</dataset>";
							}
                			...
                			foreach($receiver_filtered as $datarow)
                			{
								...
								$fixed_name = rtrim($datarow['name_element']);
								
                				$chart1xml .= "<dataset seriesName='".$fixed_name."'>";
								$chart3xml .= "<dataset seriesName='".$fixed_name."'>";
								
								foreach($table_data as $tvals)
								{
									$paths = explode(",", $tvals['path']);
									if($paths[1] == $y_id1 && $paths[3] == $datarow['element'])
									{
										$a1 = $tvals['value'];
									}
									if($paths[1] == $y_id2 && $paths[3] == $datarow['element'])
									{
										$a2 = $tvals['value'];
									}
									if($paths[1] == $y_id3 && $paths[3] == $datarow['element'])
									{
										$a3 = $tvals['value'];
									}
									if($paths[1] == $y_id4 && $paths[3] == $datarow['element'])
									{
										$a4 = $tvals['value'];
									}
									if($paths[1] == $y_id5 && $paths[3] == $datarow['element'])
									{
										$a5 = $tvals['value'];
									}
									if($paths[1] == $y_id6 && $paths[3] == $datarow['element'])
									{
										$a6 = $tvals['value'];
									}
									if($paths[1] == $y_id7 && $paths[3] == $datarow['element'])
									{
										$a7 = $tvals['value'];
									}
									if($paths[1] == $y_id8 && $paths[3] == $datarow['element'])
									{
										$a8 = $tvals['value'];
									}
									if($paths[1] == $y_id9 && $paths[3] == $datarow['element'])
									{
										$a9 = $tvals['value'];
									}
									if($paths[1] == $y_id10 && $paths[3] == $datarow['element'])
									{
										$a10 = $tvals['value'];
									}
									if($paths[1] == $y_id11 && $paths[3] == $datarow['element'])
									{
										$a11 = $tvals['value'];
									}
									if($paths[1] == $y_id12 && $paths[3] == $datarow['element'])
									{
										$a12 = $tvals['value'];
									}
								}
								...
								$chart1xml .= "</dataset>";
								$atot = $a1+$a2+$a3+$a4+$a5+$a6+$a7+$a8+$a9+$a10+$a11+$a12;
...
<script type="text/javascript">
var myChart1 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSLine.swf", "chartId_1", "650", "450", "0", "1");
...
var myChart2 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSLine.swf", "chartId_2", "650", "300", "0", "1");
...
var myChart3 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSColumn2D.swf", "chartId_3", "650", "450", "0", "1");
...
var myChart4 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSLine.swf", "chartId_4", "650", "450", "0", "1");
myChart4.setXMLData("<chart caption='Percentages' bgColor='FFFFFF' showBorder='0' canvasBorderAlpha='0' xAxisName='' connectNullData='0'  yAxisName='' showValues='0' setAdaptiveYMin='1' numberPrefix=''>"+"<?php echo $chart4xml; ?>"+"</chart>");
myChart4.render("chartContainer4");

var myChart5 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSLine.swf", "chartId_5", "650", "300", "0", "1");
...
var myChart6 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSLine.swf", "chartId_6", "650", "450", "0", "1");
myChart6.setXMLData("<chart caption='Quantities' bgColor='FFFFFF' showBorder='0' canvasBorderAlpha='0' xAxisName='' connectNullData='0'  yAxisName='' showValues='0' setAdaptiveYMin='1' numberPrefix=''>"+"<?php echo $chart6xml; ?>"+"</chart>");
