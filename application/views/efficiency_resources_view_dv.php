    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('efficiency_resources_dv'); ?>">
            ...
            <div class="content_div" >
                ...
                <table id="tb1" class="avtable_2 controller">
                	<tr data-level="header" class="header">
						...
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
						<td class="center" colspan="5">Capacity</td>
					</tr>
                	<tr data-level="header" class="header">
						<td>&nbsp;</td>
						<td style="min-width:20px !important; text-align:center !important;">&nbsp;</td>
                    ...
                    <?php
                    	...
                    	foreach($resource_set as $row)
                    	{
							...
							{
								$paths = explode(",", $drow1['path']);
								if($version1 == $paths[0] && $row['element'] == $paths['4'] && $report_value_rk == $paths['3'])
								{
									$h = $drow1['value'];
								}
								if($version2 == $paths[0] && $row['element'] == $paths['4'] && $report_value_rk == $paths['3'])
								{
									$i = $drow1['value'];
								}
								if($version3 == $paths[0] && $row['element'] == $paths['4'] && $report_value_rk == $paths['3'])
								{
									$j = $drow1['value'];
								}
								// i and j manually computed.
								/*
								if($version1 == $paths[0] && $row['element'] == $paths['4'] && $report_value_reiq == $paths['3'])
								{
									$k = $drow1['value'];
								}
								if($version1 == $paths[0] && $row['element'] == $paths['4'] && $report_value_reic == $paths['3'])
								{
									$l = $drow1['value'];
								}
								*/
					...
					<tr data-level="<?php echo $true_depth; ?>" id="level_<?php echo $true_depth."_".$sub_depth; ?>">
						...
						<td ><?php echo number_format($f_p1, 0, ".", ","); ?></td>
