...
<title>proEO | Basic Taste Testing</title>
...
<table class="content_block" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td class="tcontent" rowspan="2">
            <?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > <span class='orange'>Basic Taste Testing</span>";
            ...
            <div class="content_div" >
                ...
                <form id="form1" name="form1" method="post" action="<?php echo site_url('basic_taste_testing'); ?>">
                	<table id="tb1" class="avtable_2">
                    	...
                    	<tr>
                    		<td>
			                    ...
			                    ?>  
			                        <option value="<?php echo $row['element']; ?>" <?php if($quality_test_tts == $row['element']){ $n_quality_test_tts = $row['name_element']; ?>selected="selected"<?php } ?> ><?php echo $depth.$row['name_element']; ?></option>
			                    <?php   
			                        }
			                    ?>
			                    </select>
                    		...
                    		<td>
			                    ...
			                    ?>  
			                        <option value="<?php echo $row['element']; ?>" <?php if($quality_test_verdict == $row['element']){ $n_quality_test_verdict = $row['name_element']; ?>selected="selected"<?php } ?> ><?php echo $depth.$row['name_element']; ?></option>
			                    <?php   
			                        }
			                    ?>
			                    </select>
