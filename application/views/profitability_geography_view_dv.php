...
<title>proEO | Profitability by Geography</title>
	...
	<tr>
		<td id="tsidebar">
			...
			<div id="filter_menu">
			    <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('profitability_geography_dv'); ?>">
		...
		<td class="tcontent" rowspan="2">
			...
			" > <span class='orange'>By Geography</span> > ".
			...
			<div class="tabber">
				...
				<div class="tabbertab">
					<h3>Gross Margin by Customer</h3>
					<table>
                    	<tr>
...
var myChart2 = new FusionCharts("<?php echo base_url(); ?>assets/licensedCharts/FusionCharts_XT/Charts/MSColumn2D.swf", "chartId_2", "600", "350", "0", "1");
