	...
	<tr>
		<td id="tsidebar">
			...
			<div id="filter_menu">
			    <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('efficiency_resources_details_v2'); ?>">
		...
		<td class="tcontent" rowspan="2">
			<?php
			$breadcrumb = anchor('home', 'Home', array('title' => 'Go to Home'))." > ".anchor('efficiency_resources_v2', 'Resources', array('title' => 'View Efficiency Resources'))." > <span class='orange'>Details</span>";
