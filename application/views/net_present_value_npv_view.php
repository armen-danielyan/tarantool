...
<title>proEO | Net Present Value NPV</title>
    ...
    <tr>
        <td id="tsidebar">
            ...
            <div id="filter_menu">
                <h3>Filters</h3>
                <div>
                    <form id="form1" name="form1" method="post" action="<?php echo site_url('net_present_value_npv'); ?>">
        ...
        <td class="tcontent" rowspan="2">
            ...
            <div class="content_div" >
                ...
                <table id="tb3" class="avtable_2">
                	...
                	<tr class="tmain">
                		<td class="label">Total Resource Cost</td>
                		<td><?php echo CUR_SIGN." ".number_format(($anpv+$bnpv), 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format(($fnpv+$gnpv), 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format(($anpv+$bnpv) - ($fnpv+$gnpv), 0, ".", ","); //npv ?></td>
                	</tr>
                	
                	<tr>
                		<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Primary Cost</td>
                		<td><?php echo CUR_SIGN." ".number_format($anpv, 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format(($fnpv+$ec1_data[0]['value']), 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format($anpv - ($fnpv+$ec1_data[0]['value']), 0, ".", ","); //npv ?></td>
                	</tr>
                	<tr>
                		<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Secondary Cost</td>
                		<td><?php echo CUR_SIGN." ".number_format($bnpv, 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format($gnpv, 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format($bnpv - $gnpv, 0, ".", ","); //npv ?></td>
                	</tr>
                	
                	<tr class="tmain">
                		<td class="label">Gross Product Margin</td>
                		<td><?php echo CUR_SIGN." ".number_format(($dnpv-$enpv), 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format(($inpv-$jnpv), 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format(($dnpv-$enpv) - ($inpv-$jnpv), 0, ".", ","); //npv ?></td>
                	</tr>
                	<tr >
					...
					<tr>
                		<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Number of Units</td>
                		<td><?php echo number_format($ctot, 0, ".", ","); //npv ?></td>
                		<td><?php echo number_format($htot, 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo number_format($ctot - $htot, 0, ".", ","); //npv ?></td>
                	</tr>
                	<tr>
                		<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Net Revenue</td>
                		<td><?php echo CUR_SIGN." ".number_format($dnpv, 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format($inpv, 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format($dnpv - $inpv, 0, ".", ","); //npv ?></td>
                	</tr>
                	<tr>
                		<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Product Cost</td>
                		<td><?php echo CUR_SIGN." ".number_format($enpv, 0, ".", ","); //npv ?></td>
                		<td><?php echo CUR_SIGN." ".number_format($jnpv, 0, ".", ","); //npv ?></td>
                		
                		<td><?php echo CUR_SIGN." ".number_format($enpv - $jnpv, 0, ".", ","); //npv ?></td>
                	</tr>
                ...
                <?php
                	$investment = ($fnpv+$ec1_data[0]['value']) - $anpv;
					$chart1 = "<set label='Net Benefit' value='".$gmp."' /><set label='Investment' value='".$investment."' />";
					$chart2 = "<set label='TO-BE' value='".($inpv-$jnpv)."' /><set label='Base Line' value='".($dnpv-$enpv)."' />";
                ?>
