...
class Efficiency_Resources_Details_v2 extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$table3d_area = $version_paAP.",".$year.",".$month.",".$report_value_rqs.",".$account_element_dummy.",".$sender_as.",".$resource;
			...
			$table4d_area = $version_paAP.",".$year.",".$month.",".$report_value_rqs.",".$account_element_dummy.",".$sender_set_area.",".$resource;
			...
			$table5d_area = $version_paAP.",".$year.",".$month.",".$report_value_reco.",".$account_element_dummy.",".$resource_converted.",".$resource_ar;
			...
			$table6d_area = $version_paAP.",".$year.",".$month.",".$report_value_reco.",".$account_element_dummy.",".$resource_converted.",".$resource_set_area;
			...
			$this->load->view("efficiency_resources_details_view_v2", $alldata);
		}
	}
