...
class Efficiency_Resources_v2 extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
			...
			//chart2
			$chart2_area = $version_pa.",".$year.",".$month_all_area.",".$report_value_ro.",".$resource;
			...
			$chart2 .= $this->jedox->multichart_xml_series($chart2_data, $month_all, $version_elements_pa_alias, 2, 0, "", " Output Quantity");
			
			//chart3
			
			$chart3a_area = $version_a.",".$year.",".$month_all_area.",".$report_value_ro.",".$resource;
			$chart3b_area = $version_a.",".$year.",".$month_all_area.",".$report_value_reiq.",".$resource;
			...
			$chart3 .= $this->jedox->multichart_xml_series($chart3a_data, $month_all, $version_elements_a_alias, 2, 0, "", " Output Quantity");
			$chart3 .= $this->jedox->multichart_xml_series($chart3b_data, $month_all, $version_elements_a_alias, 2, 0, "", " Excess/Idle Capacity");
            ...
            $this->load->view("efficiency_resources_view_v2", $alldata);
        }
    }
}