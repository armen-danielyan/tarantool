...
class Net_Present_Value_Monthly extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
			...
			if($version == $version_v011)
			{
				...
				$new_area1 = $account_element_CE_9030.",".$process_elements_BP_TBM001;
				$new_area2 = $account_element_CE_9040.",".$process_elements_BP_TBM001;
			}
			if($version == $version_v012)
			{
				$new_area = $account_element_CE_9020.",".$process_elements_BP_TBM002;
				$new_area1 = $account_element_CE_9030.",".$process_elements_BP_TBM002;
				$new_area2 = $account_element_CE_9040.",".$process_elements_BP_TBM002;
			}
			if($version == $version_v013)
			{
				$new_area = $account_element_CE_9020.",".$process_elements_BP_TBM003;
				$new_area1 = $account_element_CE_9030.",".$process_elements_BP_TBM003;
				$new_area2 = $account_element_CE_9040.",".$process_elements_BP_TBM003;
			}
			if($version == $version_v014)
			{
				$new_area = $account_element_CE_9020.",".$process_elements_BP_TBM004;
				$new_area1 = $account_element_CE_9030.",".$process_elements_BP_TBM004;
				$new_area2 = $account_element_CE_9040.",".$process_elements_BP_TBM004;
			}
            ...
            $this->load->view("net_present_value_monthly_view", $alldata);
