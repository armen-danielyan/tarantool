...
class Desktop_Factory_Grist_Data_Entry extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
			...
			$quality_test1 = $this->input->post("quality_test1");
			$quality_test2 = $this->input->post("quality_test2");
			$quality_test3 = $this->input->post("quality_test3");
			$quality_test4 = $this->input->post("quality_test4");
			$quality_test5 = $this->input->post("quality_test5");
			$quality_test6 = $this->input->post("quality_test6");
			$quality_test7 = $this->input->post("quality_test7");
			$quality_test8 = $this->input->post("quality_test8"); // comment
			...
			$form_source = $this->jedoxapi->array_element_filter($source_elements, "QS_GR");
			...
			$quality_test_qt_gr_02_01 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_01");
			$quality_test_qt_gr_02_02 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_02");
			$quality_test_qt_gr_02_03 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_03");
			$quality_test_qt_gr_02_04 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_04");
			$quality_test_qt_gr_02_05 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_05");
			$quality_test_qt_gr_02_06 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_06");
			$quality_test_qt_gr_02_07 = $this->jedoxapi->get_area($quality_test_elements, "QT_GR_02_07");
			...
			if($bf != '')
			{
				...
				// save comment
				$quality_test8 = urlencode($quality_test8);
				$path8 = $version.",".$year.",".$month.",".$quality_value_co_01.",".$source.",".$product.",".$quality_test_qt_gr_02_01;
				$save8 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path8, $quality_test8);
				
				//1
				$quality_test1 = urlencode($quality_test1);
				$path1 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_01;
				$save1 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path1, $quality_test1);
				
				//2
				$quality_test2 = urlencode($quality_test2);
				$path2 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_02;
				$save2 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path2, $quality_test2);
				
				//3
				$quality_test3 = urlencode($quality_test3);
				$path3 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_03;
				$save3 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path3, $quality_test3);
				
				//4
				$quality_test4 = urlencode($quality_test4);
				$path4 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_04;
				$save4 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path4, $quality_test4);
				
				//5
				$quality_test5 = urlencode($quality_test5);
				$path5 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_05;
				$save5 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path5, $quality_test5);
				
				//6
				$quality_test6 = urlencode($quality_test6);
				$path6 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_06;
				$save6 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path6, $quality_test6);
				
				//7
				$quality_test7 = urlencode($quality_test7);
				$path7 = $version.",".$year.",".$month.",".$quality_value_qv_01.",".$source.",".$product.",".$quality_test_qt_gr_02_07;
				$save7 = $this->jedoxapi->cell_replace($server_database['database'], $quality_cube_info['cube'], $path7, $quality_test7);
            ...
            $this->load->view("desktop_factory_grist_data_entry_view", $alldata);
        }
    }
