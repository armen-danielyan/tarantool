...
class Efficiency_Balanced_Scorecard extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
            ...
            //$form_resource = $this->jedoxapi->dimension_sort_by_name($resource_elements, "RP,CCG_RG1,CCG_PL11,CCG_RG2,CCG_PL21,CCG_PL22");
			...
			if($version == '')
			{
				//$version = $form_version[1]['element'];
			...
			$balance_scorecard_value = $this->jedoxapi->array_element_filter($balance_scorecard_value_elements, "BSC");
			$balance_scorecard_value_alias = $this->jedoxapi->set_alias($balance_scorecard_value, $cells_balance_scorecard_value_alias);
			$balance_scorecard_value_area = $this->jedoxapi->get_area($balance_scorecard_value_alias);
			...
			$table_area = $version_a.":".$version_p.",".$year.",".$all_month_base_area.",".$balance_scorecard_value_area.",".$resource;
			$table_area_fy = $version_a.":".$version_p.",".$year1.":".$year2.",".$monthMA.",".$balance_scorecard_value_area.",".$resource;
            $table_area_goal = $version_p.",".$year.",".$monthMA.",".$balance_scorecard_value_area.",".$resource;
            ...
            $alldata = array(
                ...
                "balance_scorecard_value_alias" => $balance_scorecard_value_alias,
                "month1" => $month1,
                "month2" => $month2,
                "month3" => $month3,
                "month4" => $month4,
            ...
            $this->load->view("efficiency_balanced_scorecard_view", $alldata);
        }
    }
