...
class Nett_Present_Value extends CI_Controller {
    ...
    {
        $pagename = "proEO Nett Present Value";
        ...
        else 
        {
            ...
            $cube_names = "NPV_Report,#_Version,#_Margin_Value,#_Receiver,Improvement_Areas,#_Account_Element,#_Process";
			...
			// Get Dimensions ids.
            $improvement_areas_dimension_id = $this->jedoxapi->get_dimension_id($database_cubes, "Improvement_Areas");
			
			$improvement_areas_cube_info = $this->jedoxapi->get_cube_data($database_cubes, "Improvement_Areas");
            ...
            $this->load->view("nett_present_value_view", $alldata);
