...
class Efficiency_Products_Details_dv extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
            ...
            // to reduce too much changes in code. designate replacements here.
            // version_p _a _t is going to be version1 2 3.. version_AP will be unused.
            // the ap variance will be converted into the variance of the 1st 2 column.
			...
			$version_paAP = $version1.":".$version2; // at variance will be dynamically computed on view
			...
			$table2d_area = $version_pat.",".$year.",".$month.",".$report_value_rqs.",".$account_element_dummy.",".$sender_as.",".$product;
			...
			$table3d_area = $version_pat.",".$year.",".$month.",".$report_value_rqs.",".$account_element_dummy.",".$sender_set_area.",".$product; 
			
			//$table4a_area = $version_pat.",".$year.",".$month.",".$report_value_rcs.",".$account_element_dummy.",".$product_converted.",".$product_ar;
			//$table4b_area = $version_pat.",".$year.",".$month.",".$report_value_rcsf.",".$account_element_dummy.",".$product_converted.",".$product_ar;
			//$table4c_area = $version_pat.",".$year.",".$month.",".$report_value_rcsp.",".$account_element_dummy.",".$product_converted.",".$product_ar;
			//$table4d_area = $version_paAP.",".$year.",".$month.",".$report_value_rqs.",".$account_element_dummy.",".$product_converted.",".$product_ar;
			...
			$table4d_area = $version_pat.",".$year.",".$month.",".$report_value_reco.",".$account_element_dummy.",".$product_converted.",".$product_fp;
			...
			$table5d_area = $version_pat.",".$year.",".$month.",".$report_value_reco.",".$account_element_dummy.",".$product_converted.",".$product_set_area;
			...
			*/
			...
			//chart2
			$chart2a_area = $version_at.",".$year.",".$month_all_area.",".$report_value_rcp.",".$account_element_ce5.",".$sender_dummy.",".$product;
			$chart2b_area = $version_at.",".$year.",".$month_all_area.",".$report_value_rcs.",".$account_element_dummy.",".$sender_as.",".$product;
			...
			$chart2 .= $this->jedox->multichart_xml_series($chart2a_data, $month_all, $version_elements_at_alias, 2, 0, "", " Material Cost");
			$chart2 .= $this->jedox->multichart_xml_series($chart2b_data, $month_all, $version_elements_at_alias, 2, 0, "", " Conversion Cost");
            ...
            $this->load->view("efficiency_products_details_view_dv", $alldata);
