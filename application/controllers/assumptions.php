...
class Assumptions extends CI_Controller {
    ...
    {
        $pagename = "proEO Assumptions";
        $oneliner = "One-liner here for Assumptions";
        ...
        else 
        {
			...
			$value_elements_set = $this->jedoxapi->array_element_filter($value_elements, "VE_200");
            ...
            $this->load->view("assumptions_view", $alldata);
        }
    }
