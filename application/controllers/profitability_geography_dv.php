...
class Profitability_Geography_dv extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$table1_area = $version_pat.",".$year.",".$month.",".$margin_value_qty05.",".$product.",".$customer;
			$table2_area = $version_pat.",".$year.",".$month.",".$margin_value_p001.",".$product.",".$customer;
			$table3_area = $version_pat.",".$year.",".$month.",".$margin_value_sls04.",".$product.",".$customer;
			$table4_area = $version_pat.",".$year.",".$month.",".$margin_value_sls03.",".$product.",".$customer;
			$table5_area = $version_pat.",".$year.",".$month.",".$margin_value_sls.",".$product.",".$customer;
			$table6_area = $version_pat.",".$year.",".$month.",".$margin_value_craw.",".$product.",".$customer;
			$table7_area = $version_pat.",".$year.",".$month.",".$margin_value_mg01.",".$product.",".$customer;
			$table8_area = $version_pat.",".$year.",".$month.",".$margin_value_sc03.",".$product.",".$customer;
			$table9_area = $version_pat.",".$year.",".$month.",".$margin_value_mg02.",".$product.",".$customer;
			$table10_area = $version_pat.",".$year.",".$month.",".$margin_value_scf.",".$product.",".$customer;
			$table11_area = $version_pat.",".$year.",".$month.",".$margin_value_mg03.",".$product.",".$customer; 
			...
			$chart1a_area = $version_area_at.",".$year.",".$month_all_area.",".$margin_value_sls.",".$product.",".$customer;
			...
			$chart2_area = $version_area_at.",".$year.",".$month.",".$margin_value_mg03.",".$product.",".$customer_base_area; 
			...
			$chart2 = $this->jedox->multichart_xml_categories($customer_base);
			$chart2 .= $this->jedox->multichart_xml_series($chart2_data, $customer_base, $version_elements_at_alias, 5, 0);
			...
			$this->load->view("profitability_geography_view_dv", $alldata);
		}
	}
