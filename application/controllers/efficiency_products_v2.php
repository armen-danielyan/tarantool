...
class Efficiency_Products_V2 extends CI_Controller {
    ...
    public function index()
    {
        ...
        else 
        {
			...
			$table2_area = $version_patAT.",".$year.",".$month.",".$report_value_rc.",".$product_fp; // total
			...
			if($yearcheck != 0)
            {
            	$chart1a_area = $version_a.",".$prev_year_data[0]['element'].",".$month_all_area.",".$report_value_rc.",".$product_fp;
			...
			$chart2_area = $version_area_ap.",".$year.",".$month_all_area.",".$report_value_pq.",".$product_fp;
			$chart2_data = $this->jedoxapi->cell_export($server_database['database'],$product_report_cube_info['cube'],10000,"",$chart2_area, "", 1, "", "0");
			
			$chart2 .= $this->jedox->multichart_xml_series($chart2_data, $month_all, $version_elements_ap_alias, 2, 0, "", " ".$current_year);
			...
			$chart3_area = $version_area_ap.",".$year.",".$month.",".$report_value_uc.",".$product_base_area;
			...
			$chart3 .= $this->jedox->multichart_xml_series($chart3_data, $product_base, $version_elements_ap_alias, 4, 0, "", " Unit Cost");
            ...
            $this->load->view("efficiency_products_view_v2", $alldata);
