...
class Basic_Taste_Testing extends CI_Controller {
    ...
    {
        $pagename = "proEO Basic Taste Testing";
        $oneliner = "One-liner here for Basic Taste Testing";
        ...
        else 
        {
            ...
            $this->load->view("basic_taste_testing_view", $alldata);
        }
    }
